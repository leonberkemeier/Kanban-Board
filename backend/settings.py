...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-#_8ojtw(hn41+59z*h^0edkz!5@lnxcj95ipj!x=38)ntntbq$')
...
# Always use SQLite (simple and reliable for this use case)
DATABASES = {
    'default': {
